                ...
                <Row className="align-items-center">
                    <Col lg={6} className="align-self-center">
                        ...
                        <h4 className="fw-normal lh-base text-gray-700 mb-4 fs-20">
                            Passionate full-stack developer with 4+ years of experience creating scalable,
                            high-performance web applications. Focused on building efficient systems and delivering
                            seamless user experiences through thoughtful design and architecture.
                        </h4>
                    ...
                    <Col lg={5} className="ms-auto align-self-center">
                        <div className="mb-5 mb-lg-0">
                            <p className="mb-2">
                                ...
                                <span className="personal-detail-info">19 April 1999</span>
                            </p>
                            <p className="mb-2">
                                <span className="personal-detail-title">Spoken Langages</span>
                                <span className="personal-detail-info">English - Bangla</span>
                            </p>
                            <p className="mb-2">
                                <span className="personal-detail-title">Nationality</span>
                                <span className="personal-detail-info">Bangladeshi</span>
                            </p>
                            <p className="mb-2">
