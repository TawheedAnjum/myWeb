import logoSm from "@/assets/images/full-logo.svg";
...
const TopNavbar = ({ isDark }: { isDark?: boolean }) => {
    ...
    return (
        <nav
            className={`navbar navbar-expand-lg fixed-top sticky ${isDark && "light-active"} ${
        ...
        >
            <Container>
                <Link to="/" className="navbar-brand">
                    <img src={logoSm} className="logo-sm" alt="logoSm" height={50} />
                    &nbsp;
                ...
                <div className={`collapse navbar-collapse ${open && "show"}`} id="navbarNav">
                    <div className="navbar-nav mx-auto navbar-center mt-lg-0 mt-2">
                        ...
                        <li className="nav-item">
                            <a href="/resume" className={`nav-link ${pathname === "/resume" ? "active" : ""}`}>
                                Resume
                            </a>
                        </li>
                        <li className="nav-item">
                            <a href="/projects" className={`nav-link ${pathname === "/projects" ? "active" : ""}`}>
                                Projects
                            </a>
                        </li>
                        <li className="nav-item">
